...
bool foward(int distance)
{
  rightMotor(170);                                //drive the right wheel forward
  leftMotor(170);                                 //drive the left wheel forward
  delay(driveTime * distance);            //drive the motors long enough travel the entered distance
  rightMotor(0);                                  //turn the right motor off
  leftMotor(0);
  return true;//turn the left motor off
}

bool back(int distance)
{
  rightMotor(-170);                               //drive the right wheel forward
  leftMotor(-170);                                //drive the left wheel forward
  delay(driveTime * distance);            //drive the motors long enough travel the entered distance
...
void turnLeft(int distance)
{
  ...
  delay(turnTime * distance);             //drive the motors long enough turn the entered distance
  rightMotor(0);                                  //turn the right motor off
  leftMotor(0);     
}
